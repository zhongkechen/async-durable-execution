...
- **[Integrated local and cloud runner](https://zhongkechen.github.io/async-durable-execution/api/runner/local.html)** - Runner functionality now ships through `async_durable_execution`, with separate local and cloud runner factories and typed test result helpers.
