...
from async_durable_execution.runner.checkpoint.processor import (
    CheckpointProcessor,
)
...
from async_durable_execution.runner.stores.base import ExecutionStore
...
@patch("async_durable_execution.runner.checkpoint.processor.ExecutionNotifier")
...
@patch("async_durable_execution.runner.checkpoint.processor.CheckpointValidator")
@patch("async_durable_execution.runner.checkpoint.processor.OperationTransformer")
