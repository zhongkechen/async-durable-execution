...
from examples.callback import callback_serdes
from examples.callback.callback_serdes import (
    CustomData,
    CustomDataSerDes,
)
...
async def test_handle_callback_operations_with_custom_serdes(durable_runner) -> None:
