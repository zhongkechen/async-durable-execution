...
from examples.extension.wait_for_callback import wait_for_callback_serdes
from examples.extension.wait_for_callback.wait_for_callback_serdes import (
    CustomSerdes,
)
...
async def test_handle_wait_for_callback_with_custom_serdes_configuration(
    ...
    async with durable_runner(
        ...
        serialized_data = await custom_serdes.serialize(test_data)
