...
def test_none_jitter_returns_delay() -> None:
...
@patch("random.random")
def test_full_jitter_range(mock_random) -> None:
...
@patch("random.random")
def test_half_jitter_range(mock_random) -> None:
...
@patch("random.random")
def test_half_jitter_boundary_values(mock_random) -> None:
...
def test_invalid_jitter_strategy() -> None:
...
def test_duration_to_seconds_rejects_non_duration_values(duration) -> None:
...
def test_config_accepts_int_seconds() -> None:
...
@no_type_check
def test_retry_strategy_is_directly_callable() -> None:
...
def test_retry_strategy_has_no_build_method() -> None:
...
@no_type_check
def test_retryable_error_message_string() -> None:
...
@no_type_check
def test_retryable_error_message_regex() -> None:
...
@no_type_check
def test_retryable_error_type() -> None:
...
def test_delay_ceiling_applied() -> None:
...
@no_type_check
def test_default_preset_config() -> None:
...
@no_type_check
def test_transient_preset_config() -> None:
...
@no_type_check
def test_resource_availability_preset() -> None:
...
@no_type_check
def test_critical_preset_config() -> None:
...
@patch("random.random")
def test_critical_preset_no_jitter(mock_random) -> None:
...
def test_linear_preset_config() -> None:
...
def test_linear_strategy_caps_at_max_delay() -> None:
...
@patch("random.random")
def test_linear_strategy_applies_jitter(mock_random) -> None:
...
@patch("random.random")
def test_half_jitter_integration_corrected(mock_random) -> None:
...
@no_type_check
def test_no_filters_retries_all_errors() -> None:
...
@no_type_check
def test_only_retryable_errors_specified() -> None:
...
@no_type_check
def test_only_retryable_error_types_specified() -> None:
...
@no_type_check
def test_both_filters_specified_or_logic() -> None:
...
@no_type_check
def test_empty_retryable_errors_with_types() -> None:
...
@no_type_check
def test_empty_retryable_error_types_with_errors() -> None:
...
def test_empty_retryable_errors_list() -> None:
...
@no_type_check
def test_multiple_error_patterns() -> None:
...
@no_type_check
def test_mixed_error_types_and_patterns() -> None:
