...
async def handler(_event: Any, context: DurableContext) -> dict[str, Any]:
    ...
    await context.wait(timedelta(seconds=1), name="wait-invocation-1")
    ...
    callback_result_1: str = await context.wait_for_callback(
        first_submitter,
        name="first-callback",
    )
    ...
    await context.wait(timedelta(seconds=1), name="wait-invocation-2")
    ...
    callback_result_2: str = await context.wait_for_callback(
        second_submitter,
